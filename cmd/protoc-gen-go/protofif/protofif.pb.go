...
var (
	...
	E_Yamltags = &file_protofif_proto_extTypes[3]
)

// Extension fields to descriptorpb.FieldOptions.
var (
	// optional string json = 65001;
	E_Json = &file_protofif_proto_extTypes[4]
	// optional string moretags = 65002;
	E_Moretags = &file_protofif_proto_extTypes[5]
	// optional bool embed = 65003;
	E_Embed = &file_protofif_proto_extTypes[6]
)

var File_protofif_proto protoreflect.FileDescriptor

const file_protofif_proto_rawDesc = "" +
	"\n" +
	"\x0eprotofif.proto\x12\bprotofif\x1a google/protobuf/descriptor.proto\"M\n" +
	"\tTimestamp\x12\x18\n" +
...
var (
	...
	file_protofif_proto_rawDescData []byte
)

func file_protofif_proto_rawDescGZIP() []byte {
	file_protofif_proto_rawDescOnce.Do(func() {
		file_protofif_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_protofif_proto_rawDesc), len(file_protofif_proto_rawDesc)))
	})
	return file_protofif_proto_rawDescData
}

var file_protofif_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_protofif_proto_goTypes = []any{
...
func file_protofif_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_protofif_proto_rawDesc), len(file_protofif_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 7,
			NumServices:   0,
